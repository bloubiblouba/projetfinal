...
public class ModifResa extends javax.swing.JFrame {
    ...
    public ModifResa(GestionDeReservation pacc, Client c) {
        initComponents();
        this.pacc = pacc;
        this.c = c;
        nb = 200;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifResa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
